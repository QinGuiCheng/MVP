package com.minzea.base.widget.wheelPicker;
...
public class WheelPicker extends View implements IWheelPicker, Runnable {
    ...
    private void computeCurrentItemRect() {
        ...
        mRectCurrentItem.set(mRectDrawn.left - getPaddingLeft(), mWheelCenterY - mHalfItemHeight, mRectDrawn.right+ getPaddingRight(),
