package com.minzea.base.widget.ConvenientBanner;
...
import com.minzea.base.widget.ConvenientBanner.ViewPagerScroller;
import com.minzea.base.widget.ConvenientBanner.adapter.CBPageAdapter;
import com.minzea.base.widget.ConvenientBanner.holder.CBViewHolderCreator;
import com.minzea.base.widget.ConvenientBanner.listener.CBPageChangeListener;
import com.minzea.base.widget.ConvenientBanner.listener.OnItemClickListener;
import com.minzea.base.widget.ConvenientBanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(SizeUtils.dp2px(getContext(), 10), 0, 0, 0);
