...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private TextView mTvOk;                         //确认图片的选择
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvOk = (TextView) topBar.findViewById(R.id.tv_ok);
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            mTvOk.setText(getString(R.string.select_complete, imagePicker.getSelectImageCount(), imagePicker.getSelectLimit()));
            mTvOk.setEnabled(true);
        } else {
            mTvOk.setText(getString(R.string.complete));
